...
Item {
    ...
    NotificationManager {
        ...
        onNewNotification: {
            ...
            display.position.x = notificationManager.availableWidth - display.width - HeeraUI.Units.largeSpacing - 2
            display.position.y = notificationManager.availableHeight - (display.height + HeeraUI.Units.largeSpacing) * notificationModel.count
