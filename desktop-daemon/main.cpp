...
int main(int argc, char *argv[])
{
    ...
    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/heera-desktop-daemon/translations/").arg(locale.name());
    ...
    qmlRegisterType<Settings>("org.heera.Desktop", 1, 0, "Settings");
