...
ThemeManager::ThemeManager(QObject *parent)
    : QObject(parent)
    , m_settings(new QSettings(QStringLiteral("heeraos"), QStringLiteral("theme")))
{
    ...
    m_wallpaperPath = m_settings->value("Wallpaper", "/usr/share/backgrounds/heera/unsplash-4.jpg").toString();
