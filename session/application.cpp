    ...
    , m_processManager(new ProcessManager)
{
    ...
    QDBusConnection::sessionBus().registerService(QStringLiteral("org.heera.Session"));
...
void Application::initEnvironments()
{
    ...
    // Environment
    qputenv("DESKTOP_SESSION", "Heera");
    qputenv("XDG_CURRENT_DESKTOP", "Heera");
    qputenv("XDG_SESSION_DESKTOP", "Heera");

    qputenv("QT_QPA_PLATFORMTHEME", "heera");
    qputenv("QT_PLATFORM_PLUGIN", "heera");

    qputenv("QT_QUICK_CONTROLS_STYLE", "heeraui-style");
}

void Application::initLanguage()
{
    QSettings settings(QSettings::UserScope, "heeraos", "language");
